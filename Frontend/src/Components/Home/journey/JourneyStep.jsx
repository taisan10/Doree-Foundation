...
//     >
//       {/* Card */}
//       <div className="bg-white rounded-2xl shadow-lg p-4 w-[200px] h-[140px] flex items-center justify-center">
//         <img src={image} alt={title} className="max-h-full object-contain" />
//       </div>

//       {/* Dotted Line */}
//       <div className="w-px h-12 border-l-2 border-dashed border-cyan-400 my-2" />

//       {/* Dot */}
//       <div className="w-4 h-4 rounded-full bg-cyan-500" />

//       {/* Title */}
//       <h4 className="mt-3 text-lg font-semibold text-indigo-900 text-center">
//         {title}
//       </h4>
//     </div>
//   );
...
//     >
//       {/* Card */}
//       <div className="bg-white rounded-2xl shadow-lg p-4 w-[200px] h-[140px] flex items-center justify-center transition-transform duration-300 hover:scale-105">
//         <img src={image} alt={title} className="max-h-full object-contain" />
//       </div>
...
//         <div className="absolute inset-0 border-2 border-dotted border-sky-400 rounded-full animate-spin-slow"></div>
//       </div>
