        ...
        <div className="col-span-1 lg:col-span-3 lg:ml-50 -mr-10 relative  ">
          ...
          <div className="overflow-hidden  ">
            <div
              ...
              style={{ transform: `translateX(-${index * (isMobile ? 90  : 50)}%)`, }}
            >
              {images.map((item, i) => (
                <div
                  key={i}
...
// aapne meri baat ko glt smj liya muje slider ,mai 100 nahi krnaa , muje jo image mai 22 section show hotee h vo muje ek show kranaa h 700px se niche wali screen mai abhi aapne alg method use kiya vo nahi kkrna , dubara smj aadetaa hun ki   
